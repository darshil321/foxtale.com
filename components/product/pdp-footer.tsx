        ...
        <div className="flex flex-row items-center gap-5">
          <Suspense fallback={null}>
            <AddToCartButton
              ...
              buttonClasses={
                ' flex text-sm hover:text-purple-400 leading-7 leading-[22px] items-center justify-center text-base bg-white border border-black text-black py-2 px-[25px] md:py-2  md:px-10 uppercase tracking-wider font-medium'
              }
            />
          </Suspense>
          <Suspense fallback={null}>
