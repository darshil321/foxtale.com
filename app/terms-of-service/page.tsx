...
export default function TermsOfServicePage() {
  const contentClass = 'mb-5 text-gray-500';
  return (
    <WrapperContainer>
      <div className="font-poppins">
        <h3 className="mb-6 mt-4 text-xl font-semibold text-black">TERMS OF SERVICE</h3>
        <p className={contentClass}>
          This website is operated by FoxTale Consumer Private limited. Throughout the site, the
          terms “we”, “us” and “our” refer to FoxTale Consumer Private limited. FoxTale Consumer
          Private limited offers this website, including all information, tools and services
        ...
        <p className={contentClass}>
          ...
          acceptance is expressly limited to these Terms of Service. Any new features or tools which
          are added to the current store shall also be subject to the Terms of Service. You can
          review the most current version of the Terms of Service at any time on this page. We
          reserve the right to update, change or replace any part of these Terms of Service by
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 1 - ONLINE STORE TERMS</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 2 - GENERAL CONDITIONS</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 5 - PRODUCTS OR SERVICES</h3>
        <p className={contentClass}>
        ...
        <p className={contentClass}>For more detail, please review our Returns Policy.</p>
        <h3 className="text-xl font-semibold text-black">SECTION 7 - OPTIONAL TOOLS</h3>
        <p className={contentClass}>
        ...
        <p className={contentClass}>
          ...
          without any warranties, representations or conditions of any kind andwithout any
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 8 - THIRD-PARTY LINKS</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 10 - PERSONAL INFORMATION</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 12 - PROHIBITED USES</h3>
        <p className={contentClass}>
        ...
        <p className={contentClass}>
          In no case shall FoxTale Consumer Private limited, our directors, officers, employees,
          affiliates, agents, contractors, interns, suppliers, service providers or licensors be
          liable for any injury, loss, claim, or any direct, indirect, incidental, punitive,
          ...
          arising from your use of any of the service or any products procured using the service, or
          for any other claim related in any way to your use of the service or any product,
          including, but not limited to, any errors or omissions in any content, or anyloss or
          damage of any kind incurred as a result of the use of the service or any content (or
          product) posted, transmitted, or otherwise made available via the service, even if advised
          of their possibility. Because some states or jurisdictions do not allow the exclusion or
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 14 - INDEMNIFICATION</h3>
        <p className={contentClass}>
          You agree to indemnify, defend and hold harmless FoxTale Consumer Private Limited and our
          parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors,
          licensors, service providers, subcontractors, suppliers, interns and employees, harmless
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 15 - SEVERABILITY</h3>
        <p className={contentClass}>
          ...
          extent permitted by applicable law, and the unenforceable portion shall bedeemed to be
          severed from these Terms of Service, such determination shall not affect the validity and
          enforceability of any other remaining provisions.
        </p>
        <h3 className="text-xl font-semibold text-black">SECTION 16 - TERMINATION</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 17 - ENTIRE AGREEMENT</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 18 - GOVERNING LAW</h3>
        <p className={contentClass}>
        ...
        <h3 className="text-xl font-semibold text-black">SECTION 20 - CONTACT INFORMATION</h3>
        <p className={contentClass}>
          Questions about the Terms of Service should be sent to us at contact@foxtale.in
        </p>
      </div>
    </WrapperContainer>
  );
